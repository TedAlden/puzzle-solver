...
jest.mock('../../lib/pieces', () => [
  { symbol: 'A', coords: [[0, 0], [0, 1]], name: 'Piece A' },
  { symbol: 'B', coords: [[0, 0], [1, 0]], name: 'Piece B' }
]);
...
describe('PolyspherePuzzle Component', () => {
  ...
  describe('Error Handling', () => {
    test('handles worker creation failure', () => {
      ...
      render(<PolyspherePuzzle />);
      expect(consoleSpy).toHaveBeenCalledWith('Failed to create Web Worker:', expect.any(Error));
